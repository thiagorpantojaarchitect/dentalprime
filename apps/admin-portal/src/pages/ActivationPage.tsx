/** Ativacao publica do owner/administrador por token expiravel e de uso unico. */
  ...
  return (
    <div className="login-page">
      <form className="card" onSubmit={(event) => void onSubmit(event)}>
        <h2>Ativar conta administrativa</h2>
        <p className="muted">
          Use o tenant e o token recebidos no provisionamento. O token só pode ser usado
          uma vez.
        </p>
        <div className="field">
          <label htmlFor="activationTenant">Tenant</label>
          <input
            id="activationTenant"
            value={tenantId}
