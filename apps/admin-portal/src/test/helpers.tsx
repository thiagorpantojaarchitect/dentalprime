/**
 * Utilitarios de teste compartilhados: storage em memoria, mock de fetch e
 * montagem do AuthProvider com sessao semeada e roteador.
 */
...
export function sequencedFetch(
  ...
  const fn = async (): Promise<Response> => {
    ...
    i += 1;
    // Clona a Response para permitir leitura do corpo em chamadas repetidas
    // (o corpo de uma Response so pode ser lido uma vez).
