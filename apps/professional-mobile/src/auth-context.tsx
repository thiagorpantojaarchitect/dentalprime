/**
 * Contexto de autenticacao do app do profissional. Carrega a sessao do
 * SecureStore no boot, expõe login/logout e um ApiClient factory ligado a
 * sessao atual (refresh automatico em 401).
 */
