/**
 * Cliente de banco (Drizzle + node-postgres) do finance.
 */
...
export const DATABASE_SCHEMA = databaseSchemaFor("finance");
export const MIGRATIONS_TABLE = migrationTableFor("finance");
