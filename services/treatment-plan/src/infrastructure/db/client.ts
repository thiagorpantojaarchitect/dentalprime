/**
 * Cliente de banco (Drizzle + node-postgres) do treatment-plan.
 */
...
export const DATABASE_SCHEMA = databaseSchemaFor("treatment-plan");
export const MIGRATIONS_TABLE = migrationTableFor("treatment-plan");
